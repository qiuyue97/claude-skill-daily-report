...
A Claude Code plugin that automates daily work logging and report (日报) composition.
...
```
📅 日报 - [Department] - [Name] - YYYY-MM-DD

✅ Today's work (Done)
[Project] [Task] X% complete: description...
...
[Project] [High/Med/Low] specific task...
